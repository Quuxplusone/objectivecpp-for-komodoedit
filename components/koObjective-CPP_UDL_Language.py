# Registers the Objective-C++ language in Komodo.

import logging
from koUDLLanguageBase import KoUDLLanguage

log = logging.getLogger("koObjective-CPPLanguage")
#log.setLevel(logging.DEBUG)

def registerLanguage(registry):
    log.debug("Registering language Objective-C++")
    registry.registerLanguage(KoObjective_CPPLanguage())

class KoObjective_CPPLanguage(KoUDLLanguage):

    # ------------ Komodo Registration Information ------------ #

    name = "Objective-C++"
    lexresLangName = "Objective_CPP"
    _reg_desc_ = "%s Language" % name
    _reg_contractid_ = "@activestate.com/koLanguage?language=%s;1" % name
    _reg_categories_ = [("komodo-language", name)]
    _reg_clsid_ = "0a129184-7a16-40e9-866a-3f99bd04646a"
    defaultExtension = '.mm'
    ...
    _indenting_statements = ['case', 'default', 'protected', 'private', 'public']
    ...
    #           'M': 'XML',             #   XML
    #        }
    lang_from_udl_family = {'SSL': 'Objective-C++'}

...
"""A Code Intelligence Language Engine for the Objective-C++ language.
...
class Objective_CPPCILEError(CILEError):
    pass
...
log = logging.getLogger("cile.objective_cpp")
...
def scan_buf(buf, mtime=None, lang="Objective-C++"):
    """Scan the given Objective_CPPBuffer return an ElementTree (conforming
    to the CIX schema) giving a summary of its code elements.
    
    @param buf {Objective_CPPBuffer} is the Objective-C++ buffer to scan
    ...
    """
    # Dev Notes:
    # - This stub implementation of the Objective-C++ CILE return an "empty"
    #   summary for the given content, i.e. CIX content that says "there
    #   are no code elements in this Objective-C++ content".
    # - Use the following command (in the extension source dir) to
    #   debug/test your scanner:
    #       codeintel scan -p -l Objective-C++ <example-Objective-C++-file>
    ...
    # Dev Note:
    # This is where you process the Objective-C++ content and add CIX elements
    ...
    #   Use the "codeintel html -b <example-Objective-C++-file>" command as
    #   a debugging tool.
    # - "buf.accessor.text" is the whole content of the file. If you have
    #   a separate tokenizer/scanner tool for Objective-C++ content, you may
    #   want to use it.

...
"""Objective-C++ support for codeintel.
...
# These keywords are copied from "Objective-C++-mainlex.udl" - be sure to keep both
# of them in sync.
keywords = [
    ...
    'assign', 'atomic', 'copy', 'nonatomic', 'readonly', 'readwrite', 'retain'
]
...
# lexers. You must define a Lexer class for lang Objective-C++. If Komodo's
...
#   class Objective_CPPLexer(Lexer):
#       lang = lang
#       def __init__(self):
...
# examples of usage.
class Objective_CPPLangIntel(LangIntel):
    lang = lang
...
#
class Objective_CPPBuffer(CitadelBuffer):
    ...
    #css_lang = "CSS"
    #csl_lang = "JavaScript"
    #ssl_lang = "Objective-C++"
    #tpl_lang = "Objective-C++"
...
# Objective-C++ content and returns a description of the code in that file.
# See "cile_objective-cpp.py" for more details.
#
# The CILE Driver is a class that calls this CILE. If Objective-C++ is
...
class Objective_CPPCILEDriver(UDLCILEDriver):
    ...
    def scan_purelang(self, buf):
        import cile_objective_cpp
        return cile_objective_cpp.scan_buf(buf)
